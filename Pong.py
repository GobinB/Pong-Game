...
ball.penup()
ball.goto(0,0)
# ball movement code below
ball.dx = 2
ball.dy = -2

#  making a score system using (pen) this sets the default score
pen = turtle.Turtle()
pen.speed(0)
pen.color("white")
pen.penup()
...
#  Main game loop, needed for every game
...
# Border checking
    ...
    # Making the ball bounce back when it hits the paddle
